...
class CoffeeGroundTruthOptionFactory(GroundTruthOptionFactory):
    ...
    def get_options(cls, env_name: str, types: Dict[str, Type],
        ...
        PickJug = ParameterizedOption("PickJug",
                                      types=[robot_type, jug_type],
                                      params_space=Box(0, 1, (0, )),
    ...
    def _create_move_to_initial_position_policy(cls) -> ParameterizedPolicy:
        ...
        def policy(state: State, memory: Dict, objects: Sequence[Object],
            ...
            del memory, params
            robot = objects[0]
            robot_pos = (state.get(robot,
                                   "x"), state.get(robot,
                                                   "y"), state.get(robot, "z"))
            target_pos = (cls.env_cls.robot_init_x, cls.env_cls.robot_init_y,
...
class PyBulletCoffeeGroundTruthOptionFactory(_PyBulletCoffeeLegacyOptionsMixin,
    ...
    def _get_options_skill_factories(
        ...
        PickJug, PlaceJugInMachine, TurnMachineOn, Pour, and Wait use
        ...
        legacy_options = cls._get_options_legacy(env_name, types, predicates,
                                                 action_space)
        options = {PickJug, PlaceJugInMachine, TurnMachineOn, Pour, Wait}
